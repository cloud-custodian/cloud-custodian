...
RUN . /usr/local/bin/activate && pip install tools/c7n_org
"""

BUILD_MAILER = """\
# Install c7n-mailer
ADD tools/c7n_mailer /src/tools/c7n_mailer
RUN . /usr/local/bin/activate && pip install tools/c7n_mailer
"""
...
RUN . /usr/local/bin/activate && pip install tools/c7n_policystream
