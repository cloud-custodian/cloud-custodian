...
ResourceMap = {
    ...
    'gcp.notebook': 'c7n_gcp.resources.aiplatform.NotebookInstance',
    'gcp.notebook-runtime': 'c7n_gcp.resources.aiplatform.NotebookRuntime',
    'gcp.vertex-ai-endpoint': 'c7n_gcp.resources.aiplatform.VertexAIEndpoint',
