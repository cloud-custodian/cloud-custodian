ResourceMap = {
  ...
  "gcp.app-engine-firewall-ingress-rule": "c7n_gcp.resources.appengine.AppEngineFirewallIngressRule",
  ...
  "gcp.loadbalancer-backend-service": "c7n_gcp.resources.loadbalancer.LoadBalancingBackendService",
  "gcp.loadbalancer-forwarding-rule": "c7n_gcp.resources.loadbalancer.LoadBalancingForwardingRule",
  "gcp.loadbalancer-global-address": "c7n_gcp.resources.loadbalancer.LoadBalancingGlobalAddress",
  "gcp.loadbalancer-global-forwarding-rule": "c7n_gcp.resources.loadbalancer.LoadBalancingGlobalForwardingRule",
  "gcp.loadbalancer-health-check": "c7n_gcp.resources.loadbalancer.LoadBalancingHealthCheck",
  "gcp.loadbalancer-http-health-check": "c7n_gcp.resources.loadbalancer.LoadBalancingHttpHealthCheck",
  "gcp.loadbalancer-https-health-check": "c7n_gcp.resources.loadbalancer.LoadBalancingHttpsHealthCheck",
  "gcp.loadbalancer-ssl-certificate": "c7n_gcp.resources.loadbalancer.LoadBalancingSslCertificate",
  "gcp.loadbalancer-ssl-policy": "c7n_gcp.resources.loadbalancer.LoadBalancingSslPolicy",
  "gcp.loadbalancer-target-http-proxy": "c7n_gcp.resources.loadbalancer.LoadBalancingTargetHttpProxy",
  "gcp.loadbalancer-target-https-proxy": "c7n_gcp.resources.loadbalancer.LoadBalancingTargetHttpsProxy",
  "gcp.loadbalancer-target-instance": "c7n_gcp.resources.loadbalancer.LoadBalancingTargetInstance",
  "gcp.loadbalancer-target-pool": "c7n_gcp.resources.loadbalancer.LoadBalancingTargetPool",
  "gcp.loadbalancer-target-ssl-proxy": "c7n_gcp.resources.loadbalancer.LoadBalancingTargetSslProxy",
  "gcp.loadbalancer-target-tcp-proxy": "c7n_gcp.resources.loadbalancer.LoadBalancingTargetTcpProxy",
