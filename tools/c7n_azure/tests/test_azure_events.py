...
class AzureStreamEventsTest(BaseTest):
    def setUp(self):
        super(AzureStreamEventsTest, self).setUp()

    def test_get_returns_event_dict(self):
        event_dic = AzureStreamEvents.get('VmWrite')
    ...
    def test_get_event_operations_one_string(self):
        ...
        event_operations = AzureStreamEvents.get_event_operations([event_string])
    ...
    def test_get_event_operations_one_event_object(self):
        ...
        event_operations = AzureStreamEvents.get_event_operations([event_dictionary])
        self.assertEqual(len(event_operations), 1)
        self.assertEqual(event_operations[0], 'Microsoft.Compute/virtualMachines/write')
    ...
    def test_get_event_operations_both_event_types(self):
        ...
        event_operations = AzureStreamEvents.get_event_operations([event_string, event_dict])
