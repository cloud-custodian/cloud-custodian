...
class ContainerHostTest(BaseTest):
    def setUp(self):
        super(ContainerHostTest, self).setUp()
    ...
    def test_poll_queue(self, run_policy_mock, storage_mock, _1, _2):
        client_mock = Mock()
        storage_mock.get_queue_client_by_storage_account.return_value = client_mock
