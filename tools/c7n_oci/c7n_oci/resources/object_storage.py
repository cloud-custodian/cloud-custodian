...
see [Moving Resources to a Different Compartment](/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes).
    ...
    """
    schema = type_schema('update_bucket',
                         params={'type': 'object'},
    ...
    def perform_action(self, resource):
        ...
        if self.data.get('params') and self.data.get('params').get('namespace_name'):
            ...
            params_dict['namespace_name'] = resource.get('namespace', additional_details.get('namespace'))
        if self.data.get('params') and self.data.get('params').get('bucket_name'):
            ...
            params_dict['bucket_name'] = resource.get('display_name', additional_details.get('display_name'))
        if self.data.get('params').get('update_bucket_details'):
            ...
            params_dict['update_bucket_details'] = oci.object_storage.models.UpdateBucketDetails(**params_model)
