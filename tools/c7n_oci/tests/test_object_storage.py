...
class TestObjectStorage(OciBaseTest):
    def _get_bucket_details(self, object_storage):
        compartment_id = object_storage[
            "oci_objectstorage_bucket.test_bucket.compartment_id"
        ]
    ...
    def test_add_defined_tag_to_bucket(self, test, object_storage):
        ...
        """
        compartment_id, namespace_name, bucket_name = self._get_bucket_details(
            object_storage
        )
        ...
        resources = self.get_resources(
            ...
            compartment_id,
            name=bucket_name,
            **self._get_bucket_params(namespace_name)
        )
