...
class TestVcn(OciBaseTest):
    ...
    def test_add_defined_tag_to_vcn(self, test, vcn):
        ...
        policy = test.load_policy(
            {
                ...
                'actions': [
                    {
                        'type': 'update_vcn',
                        'params': {'update_vcn_details': {'defined_tags': self.get_defined_tag('add_tag')}}
                    }
                ]
            },
        ...
        policy.run()
        resources = self.get_resources(policy, compartment_id, id=vcn_ocid, **self._get_vcn_params(name))
        ...
        policy = test.load_policy(
            {
                ...
                'actions': [
                    {
                        'type': 'update_vcn',
                        'params': {'update_vcn_details': {'defined_tags': self.get_defined_tag('update_tag')}}
                    }
                ]
            },
            session_factory=session_factory
        ...
        policy = test.load_policy(
            {
                ...
                'actions': [
                    {
                        'type': 'update_vcn',
                        'params': {'update_vcn_details': {'freeform_tags': {'Environment': 'Development'}}}
                    }
                ]
            },
            session_factory=session_factory
        ...
        policy = test.load_policy(
            {
                ...
                'actions': [
                    {
                        'type': 'update_vcn',
                        'params': {'update_vcn_details': {'freeform_tags': {'Environment': 'Production'}}}
                    }
                ]
            },
            session_factory=session_factory
