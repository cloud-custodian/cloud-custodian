...
class AccountTests(BaseTest):
    ...
    def test_cloudtrail_success_management_advanced_events_included(self):
        session_factory = self.replay_flight_data("test_cloudtrail_success_management_advanced_events_included")
        p = self.load_policy(
            {
    ...
    def test_cloudtrail_fail_management_advanced_events_included(self):
        session_factory = self.replay_flight_data("test_cloudtrail_fail_management_advanced_events_included")
        p = self.load_policy(
            {
                "name": "trail-management-advanced-events-included",
                "resource": "account",
