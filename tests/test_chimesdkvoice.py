...
class TestChimeSDKVoice(BaseTest):
        ...
        self.assertEqual(
            [
                {'Tags': [{'Key': 'my-key', 'Value': 'my-value'}],
                 ...
                 'VoiceConnectorArn': 'arn:aws:chime:us-east-1:644160558196:vc/gp9yxbfhynquklulp0dyi4',
        ...
        self.assertEqual(
            [
                ...
                {'operation': 'GetResources',
                 'params': {'ResourceARNList': ['arn:aws:chime:us-east-1:644160558196:vc/ddvk97wedue2gzbz8eeeri',
                                                'arn:aws:chime:us-east-1:644160558196:vc/gp9yxbfhynquklulp0dyi4']},
    ...
    def test_chimesdkvoice_event(self):
        ...
        # See the documentation on the "arn" field in appmesh.py.
        arns = p.resource_manager.get_arns(resources)
        self.assertEqual(['arn:aws:chime:us-east-1:644160558196:vc/gp9yxbfhynquklulp0dyi4'], arns)
        ...
        self.assertEqual(
            [
                {'operation': 'ListVoiceConnectors', 'params': {}, 'service': 'chime-sdk-voice'},
                {'operation': 'GetResources',
                 'params': {'ResourceARNList': ['arn:aws:chime:us-east-1:644160558196:vc/gp9yxbfhynquklulp0dyi4']},
                 'service': 'resourcegroupstaggingapi'},
            ],
            captor.calls,
        )
