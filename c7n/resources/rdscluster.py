...
from c7n.utils import type_schema, local_session, snapshot_identifier, chunks, get_retry
...
class RetentionWindow(BaseAction):
    ...
    def set_retention_window(self, client, cluster, retention):
        params = dict(
            DBClusterIdentifier=cluster["DBClusterIdentifier"], BackupRetentionPeriod=retention
        )
