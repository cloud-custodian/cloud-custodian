...
from c7n.query import ConfigSource, DescribeSource, QueryResourceManager, TypeInfo, ChildResourceManager, ChildDescribeSource, ChildResourceQuery, sources
...
class RepositoryImageDescribeSource(ChildDescribeSource):
    ...
    def augment(self, resources):
        ...
        for repositoryName, image in resources:
            repoArn = client.describe_repositories(repositoryNames=[repositoryName])['repositories'][0]['repositoryArn']
